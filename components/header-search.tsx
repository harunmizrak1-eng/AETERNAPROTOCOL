...
export function HeaderSearch() {
  ...
  function submit(e: React.FormEvent) {
    e.preventDefault()
    const q = value.trim()
    track("Search Submitted", { hasQuery: Boolean(q), suggestionCount: suggestions.length })
