...
export function ProductGallery({ name, images, crop = false }: { name: string; images: string[]; crop?: boolean }) {
  ...
  return <>
    <div className="relative overflow-hidden border border-hairline bg-[radial-gradient(circle_at_50%_30%,#ffffff_0%,#eef6fa_72%)] p-5 sm:p-10">
      <span className="absolute left-5 top-5 z-10 border-l-2 border-gold bg-white/85 px-3 py-1.5 text-xs font-bold text-gold shadow-sm backdrop-blur">Orijinal ZPHC</span>
