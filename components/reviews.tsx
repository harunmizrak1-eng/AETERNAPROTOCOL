  ...
  return <section className="border-b border-hairline bg-surface px-6 py-12 md:px-10 md:py-16">
    <div className="mx-auto max-w-7xl rounded-2xl border border-hairline bg-background p-6 shadow-[0_14px_45px_rgba(0,49,76,0.06)] sm:p-8">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div><p className="text-xs font-bold uppercase tracking-[0.16em] text-gold">ZPHC Türkiye yorumları</p><h2 className="mt-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Gerçek müşteri deneyimleri</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">Yalnızca kontrol edilip yayınlanan site gönderimleri gösterilir; başka sitelerden yorum kopyalanmaz.</p></div>
