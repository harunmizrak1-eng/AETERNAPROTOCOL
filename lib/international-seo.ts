...
export const localeUi: Record<SeoLocale, LocaleUi> = {
  en: {
    ...
    catalogueDescription: "Browse all active ZPHC Turkey products with package format, total content, availability and manufacturer verification.",
  ...
  es: {
    ...
    catalogueDescription: "Explora todos los productos ZPHC activos en Turquía con formato, contenido total, disponibilidad y verificación del fabricante.",
  ...
  ar: {
    ...
    catalogueDescription: "استعرض جميع منتجات ZPHC النشطة في تركيا مع شكل العبوة والمحتوى الإجمالي والتوفر والتحقق من الشركة المصنّعة.",
...
export const topicTranslations: Record<SeoLocale, Record<SeoTopicId, TopicTranslation>> = {
  en: {
    ...
    bpc157: { slug: "zphc-bpc-157", title: "ZPHC BPC-157 Products in Turkey", description: "Compare ZPHC BPC-157 25 mg and active ZPHC blends containing BPC-157, with Turkey availability and manufacturer-code verification.", intro: "The single-ingredient BPC-157 set and the Glow Pro and Ultra Rehab blends have different compositions and package formats. Compare the active catalogue before opening a product record." },
    ghkcu: { slug: "zphc-ghk-cu", title: "ZPHC GHK-Cu 60 mg and 200 mg in Turkey", description: "Compare active ZPHC GHK-Cu 60 mg and 200 mg products and the Glow Pro blend, with Turkey availability and authenticity verification.", intro: "The catalogue includes standalone GHK-Cu presentations with different total content as well as a multi-ingredient blend. Each product remains clearly separated by format and composition." },
    zptrop: { slug: "zphc-zptrop-hgh", title: "ZPHC ZPtrop HGH 100 IU in Turkey", description: "View the active ZPHC ZPtrop HGH 100 IU premixed vial listing for Turkey, availability and manufacturer-code verification.", intro: "This page reflects the currently active ZPtrop presentation in the Turkey catalogue. Discontinued formats are intentionally excluded to keep availability unambiguous." },
    blends: { slug: "zphc-peptide-blends", title: "ZPHC Peptide Blends in Turkey", description: "Compare active ZPHC peptide blends including Glow Pro, Ultra Rehab, Super Slim, Wellness and Mega Mass by composition and total content.", intro: "ZPHC blends combine different ingredients and are not interchangeable. This collection separates each formula, total content and package presentation before linking to the full product record." },
  },
  es: {
    ...
    bpc157: { slug: "zphc-bpc-157", title: "Productos ZPHC BPC-157 en Turquía", description: "Compara ZPHC BPC-157 25 mg y mezclas activas que contienen BPC-157, con disponibilidad en Turquía y verificación del fabricante.", intro: "El set BPC-157 de un solo ingrediente y las mezclas Glow Pro y Ultra Rehab tienen composiciones y formatos distintos. Compara el catálogo activo antes de abrir la ficha completa." },
    ghkcu: { slug: "zphc-ghk-cu", title: "ZPHC GHK-Cu 60 mg y 200 mg en Turquía", description: "Compara los productos activos ZPHC GHK-Cu de 60 mg y 200 mg y la mezcla Glow Pro, con disponibilidad en Turquía y verificación de autenticidad.", intro: "El catálogo incluye presentaciones independientes de GHK-Cu con diferente contenido total y una mezcla de varios ingredientes. Cada formato se presenta por separado." },
    zptrop: { slug: "zphc-zptrop-hgh", title: "ZPHC ZPtrop HGH 100 IU en Turquía", description: "Consulta el producto activo ZPHC ZPtrop HGH 100 IU en vial premezclado, su disponibilidad en Turquía y la verificación del fabricante.", intro: "Esta página refleja la presentación ZPtrop actualmente activa en el catálogo de Turquía. Los formatos retirados se excluyen para evitar confusiones." },
    blends: { slug: "mezclas-peptidicas-zphc", title: "Mezclas de péptidos ZPHC en Turquía", description: "Compara las mezclas activas ZPHC Glow Pro, Ultra Rehab, Super Slim, Wellness y Mega Mass por composición y contenido total.", intro: "Las mezclas ZPHC combinan ingredientes distintos y no son equivalentes. Esta colección separa cada fórmula, contenido total y presentación." },
  },
  ar: {
    ...
    bpc157: { slug: "zphc-bpc-157", title: "منتجات ZPHC BPC-157 في تركيا", description: "قارن ZPHC BPC-157 بتركيز 25 ملغ والخلطات النشطة التي تحتوي عليه، مع التوفر في تركيا والتحقق من رمز الشركة.", intro: "تختلف مجموعة BPC-157 أحادية المكوّن عن خلطات Glow Pro وUltra Rehab في التركيب وشكل العبوة. تعرض الصفحة الكتالوج النشط بوضوح." },
    ghkcu: { slug: "zphc-ghk-cu", title: "ZPHC GHK-Cu بتركيز 60 و200 ملغ في تركيا", description: "قارن منتجات ZPHC GHK-Cu النشطة بتركيز 60 و200 ملغ وخلطة Glow Pro مع التوفر في تركيا والتحقق من الأصالة.", intro: "يتضمن الكتالوج عبوات مستقلة من GHK-Cu بمحتوى إجمالي مختلف إضافة إلى خلطة متعددة المكونات، مع فصل واضح بين كل منتج." },
    zptrop: { slug: "zphc-zptrop-hgh", title: "ZPHC ZPtrop HGH 100 IU في تركيا", description: "اطلع على عبوة ZPHC ZPtrop HGH 100 IU النشطة في تركيا والتوفر والتحقق من رمز الشركة المصنّعة.", intro: "تعكس هذه الصفحة عرض ZPtrop النشط حالياً في كتالوج تركيا، مع استبعاد الأشكال المتوقفة لتجنب الالتباس." },
    blends: { slug: "zphc-peptide-blends", title: "خلطات ببتيدات ZPHC في تركيا", description: "قارن خلطات ZPHC النشطة مثل Glow Pro وUltra Rehab وSuper Slim وWellness وMega Mass حسب التركيب والمحتوى.", intro: "تحتوي خلطات ZPHC على مكونات مختلفة وليست متطابقة. تفصل هذه المجموعة بين كل تركيبة ومحتواها الإجمالي وشكل العبوة." },
  },
}
