...
export const topicTranslations: Record<SeoLocale, Record<SeoTopicId, TopicTranslation>> = {
  en: {
    ...
    tirzepatide: { slug: "zphc-tirzepatide", title: "ZPHC Tirzepatide (Tirze) | No active products", description: "Tirze products are not currently listed in the active ZPHC Turkey catalogue.", intro: "This product family has been removed from the active Turkey catalogue." },
  },
  es: {
    ...
    tirzepatide: { slug: "zphc-tirzepatida", title: "ZPHC Tirzepatida (Tirze) | Sin productos activos", description: "Los productos Tirze no están incluidos actualmente en el catálogo activo de ZPHC Turquía.", intro: "Esta familia de productos se ha retirado del catálogo activo de Turquía." },
  },
  ar: {
    ...
    tirzepatide: { slug: "zphc-tirzepatide", title: "ZPHC Tirzepatide (Tirze) | لا توجد منتجات نشطة", description: "منتجات Tirze غير مدرجة حالياً في كتالوج ZPHC تركيا النشط.", intro: "تمت إزالة عائلة المنتجات هذه من الكتالوج النشط في تركيا." },
  },
}
