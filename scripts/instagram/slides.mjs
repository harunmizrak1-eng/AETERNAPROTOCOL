...
export const sets = {
  bpc157: {
    ...
    slides: [
      ...
      {
        type: "verify",
        heading: "Aldığınız ürün sahte mi?",
        body: "Kutunun üstündeki gümüş bandı kazıyın. Altından çıkan kodu validation.zphc.com adresine yazın. Cevabı biz değil, ürünü üreten firma veriyor.",
      },
  ...
  dogrulama: {
    ...
    slides: [
      ...
      },
      {
        ...
        body: "Kodu validation.zphc.com adresine yazıp Check düğmesine basın. Bu sorgu bizim sitemizde değil, ZPHC'nin kendi sisteminde yapılır.",
      },
      {
        type: "list",
      ...
      },
      {
        ...
        body: "Bant sizden önce kazınmışsa bu kötüye işarettir, kodu başkası görmüş demektir. Kutunun mührü kırıksa ürünü hiç kullanmayın.",
      },
      { type: "cta", heading: "ZPHC Türkiye", body: "Resmi distribütör" },
    ],
  },
